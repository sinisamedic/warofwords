...
if(!process.argv.includes('--serial')||!/^emulator-\d+$/.test(serial)||!process.argv.includes('--apk')||!fs.existsSync(apk))throw Error('Use --serial emulator-5554 --apk exports/WarOfWords-0.1.5-android.apk');
