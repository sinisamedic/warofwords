...
def make_docs():
    ...
    for p in POSTS:
        ...
        blocks.append(f"\n## {p['id']}. {p['title']}\n\n- **Ideja i cilj:** {p['goal']}\n- **Hook:** {p['hook']}\n- **Raspored:** {p['day']} • 19:00 (predlog)\n- **Format:** {p['kind']}\n- **Fajlovi:** `{folder}/ig-*.png`, `{folder}/video-9x16-audio.mp4`, `{folder}/cover-9x16.jpg`.\n\n**Instagram ({igkind}) — gotov opis:**\n\n{p['caption']}\n\n{p['tags']}\n\n**TikTok — gotov opis uz vertikalni MP4:**\n\n{p['short']}\n\n{p['tags']}\n\n**YouTube Shorts — naslov:** {p['title']}\n\n**YouTube Shorts — opis:**\n\n{youtube}\n\n{p['tags']} #Shorts\n\n**Poziv na reakciju:** {p['cta']}\n\n**Alt tekst za IG:** {p['alt']}\n")
        page.append(f'<section><h2>{p["id"]}. {html.escape(p["title"])}</h2><p>{p["day"]} · {p["kind"]}</p><p>{p["goal"]}</p><div class="media"><div><a href="{folder}/video-9x16-audio.mp4" download><img src="{folder}/cover-9x16.jpg" alt="Video naslovna slika"></a><p><a href="{folder}/video-9x16-audio.mp4" download>Preuzmi MP4 sa muzikom i efektima</a><br><a href="{folder}/preview.webm" download>Izvorni nemi WebM pregled</a></p></div>')
