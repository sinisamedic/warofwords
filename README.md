...
**Android 0.1.12:** očišćena ilustracija Proboja, ukrašen dijalog za novu opremu i ikonice nagrada uz odabrani nivo kampanje. Nepotvrđene nagrade ostaju sačuvane kroz restart. Prvi talas opreme, dnevni izazov i globalna rang-lista ostaju dostupni. [Online režim i postavljanje](docs/daily-online.md).
...
- [Preuzmi APK 0.1.12](https://github.com/sinisamedic/warofwords/releases/download/v0.1.12-android-preview/WarOfWords-0.1.12-android.apk). Lokalno: `exports/WarOfWords-0.1.12-android.apk`. **Instalira se preko 0.1.11 ili 0.1.10 bez deinstalacije**, sa istim potpisom; prelazak sa 0.1.11 čuva napredak (provereno u emulatoru). Potpis se razlikuje od kućnih verzija 0.1.7–0.1.9 kao i kod prethodnog paketa; pri prelasku sa njih potrebna je deinstalacija koja briše lokalni napredak. Stanje objave: [STATUS.md](STATUS.md).
...
[Pravila i balans](docs/game-design.md) · [Provere i granice verzije](docs/QA-0.1.12.md) · [Status i sledeći korak](STATUS.md).
