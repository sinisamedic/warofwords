...
**Igriva Android verzija 0.1.4 u Godotu 4.7.2.** Landscape duel protiv računara: povezuj engleska ili srpska slova, uz izbor susednog ili slobodnog povezivanja, napuni borbene sposobnosti i savladaj 12 susreta. Sve radi offline. Radni naziv i balans mogu se menjati nakon testa na telefonu.

## Probaj igru

- APK: [WarOfWords-0.1.4-android.apk](https://github.com/sinisamedic/warofwords/releases/download/v0.1.4-android-preview/WarOfWords-0.1.4-android.apk). Lokalni build je u ignorisanom `exports/`.
...
[Pravila i balans](docs/game-design.md) · [Provere i granice verzije](docs/QA-0.1.4.md) · [Status i sledeći korak](STATUS.md).

U 0.1.4: uže centrirano PLAY dugme, detaljno energetsko polje štita, protivnici poravnati sa tlom, ispravno okrenut Bridge Guardian, oreoli spremnih sposobnosti i animacije završnog udarca/poraza pre rezultata.

## Nastavi na drugom računaru

Prvo pročitati [AGENTS.md](AGENTS.md), zaštititi postojeće izmene i proveriti remote. Aktivna radna grana je **codex/shields-defeat-ready-effects**:
...
Ako grana nije lokalna: `git switch --track origin/codex/shields-defeat-ready-effects`. GitHub prenosi izvor i asset-e; Godot, Android SDK, JDK i export templates se instaliraju zasebno. [Podešavanje računara](docs/setup.md).
