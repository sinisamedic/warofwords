...
## Campaign wave two artwork (2026-09-18)

Eight original illustrations generated with the built-in OpenAI ImageGen tool, copied unchanged: `enemies-wave-two.png` (12 transparent characters in campaign order, 4 columns × 3 rows), `campaign-forge.png`, `campaign-garden.png`, `campaign-citadel.png`, and `equipment-ember.png`, `equipment-resonator.png`, `equipment-bastion.png`, `equipment-siphon.png`. Exact prompts: `prompts-wave-two.json`. No external franchise or stock artwork was used; applicable OpenAI terms apply, no third-party stock license is claimed. The runtime selects individual atlas regions and portraits without editing the source image. Every file is below 3 MiB; existing regular Git asset storage retained after size review, no history migration or LFS introduced.
